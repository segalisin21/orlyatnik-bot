...
Тон: тёплый, дружелюбный, без лишнего пафоса. Отвечай кратко и по делу.
...
export async function getFormModeReply(
  ...
  const systemForm = `Ты помогаешь заполнить анкету участника «${eventName}». Тон: живой, дружелюбный, с лёгким юмором — как в примерах ответов бота (приветливо, с эмодзи где уместно).
