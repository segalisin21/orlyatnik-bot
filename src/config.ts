...
export const kb = {
  ...
  CONDITIONS_TEXT: 'Стоимость 21 000 ₽. Задаток 10 000 ₽ для брони. Оплата на Сбер: 89050293388 — Кристина Владимировна. Комментарии при переводе не нужны. Заезд 16–17:00, выезд 15:00. По вопросам — @krisis_pr.',
} as const;
