...
*Логика: /start всегда показывает приветствие и выбор мероприятия. В меню мероприятия есть возврат к выбору (Сменить мероприятие). У каждого мероприятия свои даты, описание программы и стоимость.*
