...
flowchart LR
  ...
  subgraph orlyatnikBranch ["Ветка Орлятник"]
    ...
    OPayChoice["Выбор способа оплаты:\n• перевод на карту\n• онлайн (ЮKassa)"]
  ...
  subgraph pizhamnikBranch ["Ветка Пижамник"]
    ...
    PPayChoice["Выбор способа оплаты:\n• перевод на карту\n• онлайн (ЮKassa)"]
...
```
  [Забронировать] / «хочу забронировать»
         ...
         └──────────┬───────────┘
            ...
            ▼                ▼
   ┌─────────────────┐  ┌────────────────────┐
   │ Перевод на карту│  │ Онлайн-оплата      │
   │ Реквизиты +     │  │ Ссылка ЮKassa +    │
   │ повтор анкеты,  │  │ инструкция «пришли │
   │ «пришли чек»    │  │ чек после оплаты»  │
   └─────────┬───────┘  └───────────┬────────┘
         └──────────┬───────────┘
                    │
                    ▼
...
| **Текст «Да» / «Подтверждаю»** (на шаге анкеты) или кнопка [Подтверждаю] | Переход к экрану выбора способа оплаты: [Перевод на карту] / [Онлайн (ЮKassa)] |
